        ...
        <section id="plantation" className="py-14 sm:py-18 md:py-20 lg:py-24 xl:py-28">
            <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-12 auto-rows-[170px] sm:auto-rows-[150px] md:auto-rows-[140px] gap-2 sm:gap-3">
                    <div className="ph col-span-1 row-span-2 md:col-span-5 md:row-span-3">
                    ...
                    <div className="ph col-span-1 row-span-2 md:col-span-4 md:row-span-3">
                        <Photo src="https://res.cloudinary.com/ddxvnb0nk/image/upload/q_auto/f_auto/v1779376704/samples/landscapes/beach-boat.jpg" alt="" />
                    ...
                    <div className="ph col-span-1 row-span-1 md:col-span-3 md:row-span-1">
                        <Photo src="https://res.cloudinary.com/ddxvnb0nk/image/upload/q_auto/f_auto/v1779376704/samples/landscapes/beach-boat.jpg" alt="" />
