            ...
            <section className="relative overflow-hidden">
                <div className="max-w-content mx-auto px-6 lg:px-10 pt-16 lg:pt-24 pb-14 lg:pb-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3">
                        <a
                            href="#short"
                            className="group p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-line"
                        >
                            ...
                            <p className="mt-3 text-[13.5px] text-mute leading-[1.7]">
                                Melon, corn, banana — quick rotations with guaranteed off-take.
                                Built for first-time investors.
                            </p>
                            <div className="mt-6 text-[13px] text-accent">
                    ...
                    <div className="grid grid-cols-12 gap-6 lg:gap-12">
                        <div className="col-span-12 lg:col-span-7">
                            ...
                            <ul className="mt-10 space-y-3 max-w-[560px]">
                                <li className="branch text-[14.5px]">
                            ...
                            <div className="mt-12">
                                ...
                                <ol className="divide-y divide-line">
                                    <li className="flex items-baseline justify-between py-3 text-[14.5px]">
                                        <span>
                        ...
                        <aside className="col-span-12 lg:col-span-5 space-y-4">
                            ...
                            <div className="rounded-[18px] bg-accent2 p-6 lg:p-8">
                                ...
                                <dl className="grid grid-cols-2 gap-y-3 text-[13.5px]">
                                    <dt className="text-mute">Min. ticket</dt>
                                    <dd className="font-display text-[18px]">LKR 250,000</dd>
                                    <dt className="text-mute">Term</dt>
                                    <dd className="font-display text-[18px]">6 months</dd>
                                    <dt className="text-mute">Target IRR</dt>
                                    <dd className="font-display text-[18px]">22 — 28%</dd>
                                    <dt className="text-mute">Pricing</dt>
                                    <dd className="font-display text-[18px]">Sealed at planting</dd>
                                </dl>
                            </div>
                        </aside>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-6 lg:gap-12">
                        <aside className="col-span-12 lg:col-span-5 space-y-4 order-2 lg:order-1">
                            ...
                            <div className="rounded-[18px] bg-ink text-ondark p-6 lg:p-8">
                                <div className="num text-ondark/70! mb-4">
                                    Tier 02 — at a glance
                                </div>
                                <dl className="grid grid-cols-2 gap-y-3 text-[13.5px]">
                                    <dt className="opacity-60">Min. ticket</dt>
                                    <dd className="font-display text-[18px]">LKR 1,200,000</dd>
                                    <dt className="opacity-60">Term</dt>
                                    <dd className="font-display text-[18px]">12 months</dd>
                                    <dt className="opacity-60">Target IRR</dt>
                                    <dd className="font-display text-[18px]">28 — 36%</dd>
                                    <dt className="opacity-60">Land</dt>
                                    <dd className="font-display text-[18px]">Below 2 acres</dd>
                                </dl>
                            </div>
                    ...
                    <div className="grid grid-cols-12 gap-6 lg:gap-12">
                        ...
                        <aside className="col-span-12 lg:col-span-5 space-y-4">
                            ...
                            <div className="rounded-[18px] bg-accent2 p-6 lg:p-8">
                                ...
                                <dl className="grid grid-cols-2 gap-y-3 text-[13.5px]">
                                    <dt className="text-mute">Min. ticket</dt>
                                    <dd className="font-display text-[18px]">LKR 5,000,000</dd>
                                    <dt className="text-mute">Term</dt>
                                    <dd className="font-display text-[18px]">2 — 5 years</dd>
                                    <dt className="text-mute">Target IRR</dt>
                                    <dd className="font-display text-[18px]">
                                        18 — 24% (compounded)
                                    </dd>
                                    <dt className="text-mute">Land</dt>
                                    <dd className="font-display text-[18px]">PGG or stakeholder</dd>
                                </dl>
                            </div>
                        </aside>
                    </div>
