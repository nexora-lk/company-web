                ...
                <div className="relative rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-3xl xl:rounded-4xl overflow-hidden bg-ink text-ondark">
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-14 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-14">
                        ...
                        <div className="md:col-span-1 lg:col-span-5 flex flex-col">
                            ...
                            <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16 rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-2xl bg-bg/5 border border-ondark/10 p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 hover:bg-bg/10 transition-all duration-300">
                        ...
                        {/* Right Column - Form */}
                        <div className="md:col-span-1 lg:col-span-7 mt-8 sm:mt-10 md:mt-0">
