...
const steps: Step[] = [
    ...
    },
    {
        ...
        title: "Deposit",
        icon: Landmark,
        youDo: "Make the deposit as per the agreed quotation to confirm and initiate the solutions.",
    ...
    },
    {
        ...
        icon: ClipboardCheck,
        youDo: "Review the solutions agreement with your Relationship Manager.",
        weDo: "Visit you again to review and proceed with the solutions agreement based on collected documents.",
