        ...
        <section className="relative overflow-hidden">
            <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10 pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 lg:pb-16">
                ...
                <div className="grid grid-cols-12 gap-6 sm:gap-8 items-end">
                    <h1 className="col-span-12 lg:col-span-8 font-display text-[42px] sm:text-[64px] md:text-[84px] lg:text-[108px] xl:text-[128px] leading-[0.93] tracking-tightish">
                        Ribbons cut.
                        <br />
                    ...
                    <p className="col-span-12 lg:col-span-4 text-mute text-[14px] sm:text-[15px] md:text-[15.5px] leading-[1.7] max-w-full sm:max-w-[480px] lg:max-w-none lg:pb-3">
