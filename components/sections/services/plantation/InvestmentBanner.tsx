        ...
        <section className="py-10 xs:py-12 md:py-12 lg:py-13 xl:py-14 bg-bg">
            ...
            <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10">
                <div className="relative rounded-[20px] sm:rounded-[28px] lg:rounded-[32px] overflow-hidden min-h-[360px] sm:min-h-[480px] md:min-h-[540px] lg:min-h-[600px] flex items-end reveal">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-tr from-midnight-blue/95 via-midnight-blue/65 to-midnight-blue/15" />
                    <span aria-hidden className="pointer-events-none absolute -top-16 right-0 w-80 h-80 bg-normal-gold/10 rounded-full blur-3xl" />
                        ...
                        <div className="grid grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-16 items-end">
                            ...
                            <div className="col-span-12 lg:col-span-8 reveal">
                                ...
                                <h2 className="font-display text-[28px] sm:text-[40px] md:text-[52px] lg:text-[60px] xl:text-[72px] leading-[1.0] sm:leading-[0.98] tracking-tightish">
                                    Leased Properties, Property <em className="serif-em text-light-gold">Management</em>{' '}
                                    & Joint Ventures.
                                </h2>
                            ...
                            <div className="col-span-12 lg:col-span-4 flex flex-col gap-4 lg:items-end mt-4 sm:mt-6 lg:mt-0 reveal">
                                <Link
                                    href="/investment"
                                    className="btn bg-bg text-midnight-blue hover:bg-light-gold hover:text-midnight-blue w-full sm:w-auto justify-center text-[14px] sm:text-[15px] px-8 py-4 sm:py-5"
                                >
