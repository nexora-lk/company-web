        ...
        <section className="pb-20 sm:pb-24 lg:pb-36">
            <div className="max-w-content mx-auto px-4 xs:px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="p-6 xs:p-8 lg:p-10 border-b sm:border-r border-line">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 border-b lg:border-r border-line">
                        <h3 className="font-display text-[24px] xs:text-[26px] sm:text-[28px] leading-tight">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 border-b sm:border-r lg:border-r-0 border-line">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 border-b lg:border-r border-line lg:border-b-0">
                        <h3 className="font-display text-[24px] xs:text-[26px] sm:text-[28px] leading-tight">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 border-b sm:border-r border-line sm:border-b-0">
                        <h3 className="font-display text-[24px] xs:text-[26px] sm:text-[28px] leading-tight">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 border-b lg:border-r-0 border-line lg:border-b-0 sm:border-b-0">
                        <h3 className="font-display text-[24px] xs:text-[26px] sm:text-[28px] leading-tight">
                    ...
                    <div className="p-6 xs:p-8 lg:p-10 bg-accent2 flex flex-col justify-center min-h-[220px] xs:min-h-[240px] sm:min-h-[280px]">
