                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
                                <article className="step group">
                                    ...
                                    <p className="mt-3 text-[14px] text-mute leading-[1.7]">
                                        Pick the model — short, mid, or long term — that aligns with your
                                        goals and commitment window. We send a tailored prospectus within 48
                                        hours.
                                    </p>
                                </article>
                                ...
                                <article className="step group">
                                    ...
                                    <p className="mt-3 text-[14px] text-mute leading-[1.7]">
                                        A short, plain-language agreement with the guaranteed-return clause
                                        and off-take pricing spelled out. Witnessed by Colombo legal.
                                    </p>
                                </article>
                                ...
                                <article className="step group">
                                    ...
                                    <p className="mt-3 text-[14px] text-mute leading-[1.7]">
                                        Monthly written reports on project progress, financial performance
                                        and ROI updates. Quarterly KPMG-audited statements thereafter.
                                    </p>
                                </article>
                            </div>
                        </div>
