...
export default function HeroBanner() {
    ...
    return (
        <>
            {/* ─── Open Roles ─────────────────────────────────────────────── */}
            <section ref={rolesSectionRef} className="py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16 bg-bg" id="open-roles">
                <Leaf variant="bl" />
            ...
            {showForm && (
                <section ref={formSectionRef} className="pb-20 sm:pb-24 lg:pb-36 bg-surface" id="application-form">
                    <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10">
