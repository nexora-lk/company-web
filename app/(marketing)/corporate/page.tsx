...
export const metadata: Metadata = {
    title: 'Corporate Information | Prestige Glamour Group',
    description:
        'Corporate governance, regulatory compliance, leadership, and legal structure of Prestige Glamour Group. Registered under Sri Lanka business law, audited by KPMG.',
    alternates: {
        canonical: 'https://www.prestigeglamourgroupofcompany.com/corporate',
    },
    openGraph: {
        title: 'Corporate Governance & Compliance',
        description:
            'Learn about our legal structure, leadership, regulatory compliance, and strategic partnerships.',
        url: 'https://www.prestigeglamourgroupofcompany.com/corporate',
        type: 'website',
    },
};
                    ...
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            },
                            {
                                ...
                                item: 'https://www.prestigeglamourgroupofcompany.com/corporate',
                            },
                        ],
                    }),
                }}
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        '@context': 'https://schema.org',
                        '@type': 'LocalBusiness',
                        name: 'Prestige Glamour Group (Pvt) Ltd',
                        description: 'Sri Lankan conglomerate with corporate offices in Colombo.',
                        address: {
                            '@type': 'PostalAddress',
                            streetAddress: 'No. 42, Bauddhaloka Mawatha',
                        ...
                        <div className="col-span-12 lg:col-span-8 space-y-8">
                            ...
                            <div className="info-card p-8 lg:p-10">
                                ...
                                <p className="mt-6 text-mute text-[15px] leading-[1.75] max-w-[640px]">
                                    ...
                                    funded directly from group profits and reported in the annual
                                    impact statement.
                                </p>
                                ...
                                <div className="mt-8 flex flex-wrap gap-3">
                                    ...
                                    <a href="#" className="btn btn-ghost">
                                        View NGO Partners <span className="arrow">→</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <aside className="col-span-12 lg:col-span-4 lg:sticky lg:top-24 space-y-6">
                            <div className="sidebar-dark p-8 lg:p-10">
                                ...
                                <div className="mt-8 space-y-4 text-[14px]">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="opacity-60 text-[11px] uppercase tracking-[0.18em]">
                                                Phone
                                            </div>
                            ...
                            <div className="info-card p-6">
                                ...
                                <div className="font-display text-[22px] leading-tight">
                                    Six businesses.
                                    <br />
                                    <em className="serif-em">One</em> island.
                                </div>
            ...
            <section className="pb-24 lg:pb-36">
                <div className="max-w-content mx-auto px-6 lg:px-10">
                    <div className="relative rounded-[24px] overflow-hidden min-h-[320px] flex items-end">
                        <Photo
                            src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1800&q=80&auto=format&fit=crop"
                            alt=""
                            priority
                            ...
                            <div className="grid grid-cols-12 gap-8 items-end">
                                <div className="col-span-12 lg:col-span-8">
                                    ...
                                    <p className="mt-5 max-w-[520px] text-[14.5px] opacity-85">
                                        Audited statements, board minutes and regulatory filings are
                                        available to shareholders and accredited investors under
                                        NDA.
                                    </p>
                                </div>
                                <div className="col-span-12 lg:col-span-4 flex flex-col gap-3 lg:items-end">
                                    ...
                                    >
                                        Request documents <span className="arrow">→</span>
                                    </Link>
                                    <Link href="/about" className="text-ondark text-sm ulink">
                                        Or read about our leadership
                                    </Link>
                                </div>
                            </div>
                        </div>
