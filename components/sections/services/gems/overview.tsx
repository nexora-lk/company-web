            ...
            <div className="max-w-content mx-auto px-4 xs:px-6 lg:px-10">
                <div className="grid grid-cols-12 gap-8 lg:gap-16 xl:gap-24 items-center">
                    ...
                    <div className="col-span-12 lg:col-span-7 order-2 lg:order-1">
                        ...
                        <div className="mt-8 xs:mt-10 space-y-5 xs:space-y-6 text-[14.5px] xs:text-[15.5px] text-mute leading-relaxed sm:leading-[1.75] font-light max-w-full sm:max-w-[640px]">
                            <p>
                        ...
                        <div className="mt-10 xs:mt-12 p-6 xs:p-8 bg-accent2 rounded-[20px] xs:rounded-[24px] border border-accent/15 shadow-sm hover:shadow-md transition-shadow duration-500">
                    ...
                    <aside className="col-span-12 lg:col-span-5 order-1 lg:order-2 space-y-4 xs:gap-6 lg:sticky lg:top-32 mt-4 lg:mt-0">
                        <figure className="rounded-[18px] xs:rounded-[24px] overflow-hidden aspect-[3/2] xs:aspect-[4/3] lg:aspect-[4/5] shadow-2xl transition-transform duration-700 hover:scale-[1.02]">
                            <Photo
                        ...
                        <div className="rounded-[18px] xs:rounded-[24px] bg-ink text-ondark p-6 xs:p-8 lg:p-10 shadow-2xl relative overflow-hidden">
