            ...
            <div className="max-w-content mx-auto px-4 xs:px-6 lg:px-10">
                <div className="grid grid-cols-12 gap-8 lg:gap-16 xl:gap-24 items-start">
                    <div className="col-span-12 lg:col-span-7 order-2 lg:order-1">
                        ...
                        <p className="mt-6 xs:mt-8 text-[14px] xs:text-[15px] text-mute leading-relaxed sm:leading-[1.75] max-w-full sm:max-w-[620px] font-light">
                        ...
                        <p className="mt-4 xs:mt-5 text-[14px] xs:text-[15px] text-mute leading-relaxed max-w-full sm:max-w-[620px] font-light">
                        ...
                        <div className="mt-10 xs:mt-12 space-y-6 xs:gap-8">
                            {/* Leased Properties */}
                            <div className="border border-line rounded-[20px] overflow-hidden bg-white/60 backdrop-blur-md shadow-sm">
                    ...
                    <aside className="col-span-12 lg:col-span-5 order-1 lg:order-2 space-y-5 lg:sticky lg:top-32 mt-4 lg:mt-0">
                        <figure className="rounded-[18px] xs:rounded-[24px] overflow-hidden aspect-[4/3] shadow-2xl">
                            <Photo
                        ...
                        <div className="rounded-[20px] xs:rounded-[24px] bg-ink text-ondark p-8 lg:p-10 shadow-xl border border-white/5">
