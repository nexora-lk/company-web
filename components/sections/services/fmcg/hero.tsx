...
export default function HeroSection() {
    return (
        <section className="relative overflow-hidden bg-cover bg-center bg-no-repeat min-h-screen flex flex-col justify-center" style={{backgroundImage: "url('https://res.cloudinary.com/ddxvnb0nk/image/upload/q_auto/f_auto/v1780124967/fmcg-hero_ow6agn.jpg')"}}>
            ...
            <div className="relative z-10 max-w-content mx-auto px-6 lg:px-10 pt-16 lg:pt-24 pb-14 lg:pb-20">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <span className="eyebrow !text-white/70">PGG Fresh Foods · Farm to Fork · Est. 2019</span>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4">
                    <div className="p-8 border-r border-white/70">
                        <div className="num !text-white/90 mb-4">Product lines</div>
                        ...
                        <div className="text-[12px] !text-white/75 mt-2">Fresh &amp; processed</div>
                    </div>
                    <div className="p-8 lg:border-r border-white/70">
                        <div className="num !text-white/90 mb-4">Retail partners</div>
                        <div className="font-display text-[56px] leading-none tracking-tightish !text-white">
                            240<em className="serif-em text-accent text-[20px]">.</em>
                        </div>
                        <div className="text-[12px] !text-white/75 mt-2">Across Sri Lanka</div>
                    </div>
                    <div className="p-8 border-r border-white/70 border-t lg:border-t-0">
                        <div className="num !text-white/90 mb-4">Processing capacity</div>
                        <div className="font-display text-[56px] leading-none tracking-tightish !text-white">
                            5<em className="serif-em text-accent text-[20px]">T</em>
                        </div>
                        <div className="text-[12px] !text-white/75 mt-2">Tonnes per day</div>
                    </div>
                    <div className="p-8 border-t lg:border-t-0">
                        <div className="num !text-white/90 mb-4">Export revenue</div>
                        <div className="font-display text-[56px] leading-none tracking-tightish !text-white">
                            42<em className="serif-em text-accent text-[20px]">%</em>
                        </div>
                        <div className="text-[12px] !text-white/75 mt-2">Of total sales · 2025</div>
                    </div>
                </div>
