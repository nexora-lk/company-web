            ...
            <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10">
                <div className="relative rounded-[18px] sm:rounded-[24px] overflow-hidden min-h-[300px] sm:min-h-[340px] md:min-h-[380px] flex items-end bg-ink">
                    <div className="relative w-full p-6 sm:p-10 lg:p-12 xl:p-14 text-ondark">
                        <div className="grid grid-cols-12 gap-5 sm:gap-6 md:gap-8 items-end reveal">
                            ...
                            <div className="col-span-12 lg:col-span-4 flex flex-row lg:flex-col gap-3 sm:gap-4 lg:items-end mt-2 lg:mt-0 reveal">
                                <Link
                                    href="/#contact"
