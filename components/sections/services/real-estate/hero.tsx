...
export default function HeroSection() {
    return (
        <section className="relative overflow-hidden bg-cover bg-center bg-no-repeat min-h-screen flex flex-col justify-center" style={{backgroundImage: "url('https://res.cloudinary.com/ddxvnb0nk/image/upload/q_auto/f_auto/v1780117668/real-estate-hero_z5rass.jpg')"}}>
            ...
            <div className="relative z-10 max-w-content mx-auto px-4 sm:px-6 md:px-8 lg:px-10 pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-10 sm:pb-14 md:pb-16 lg:pb-20">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-6 sm:mb-8 md:mb-10">
                    ...
                    <span className="num text-white/80! text-[11px] sm:text-xs md:text-sm">Real Estate</span>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-0">
                    <div className="p-4 sm:p-6 md:p-7 lg:p-8 border-r border-white/70">
                        <div className="num text-white/90! mb-2 sm:mb-3 md:mb-4 text-[11px] sm:text-xs md:text-sm lg:text-base">Total land bank</div>
                        <div className="font-display text-[36px] sm:text-[44px] md:text-[52px] lg:text-[56px] leading-none tracking-tightish text-white!">
                            840<em className="serif-em text-accent text-[18px] sm:text-[20px] md:text-[24px] lg:text-[20px]">A</em>
                        </div>
                        <div className="text-[10px] sm:text-[11px] md:text-xs text-white/75! mt-1 sm:mt-2">Acres managed</div>
                    </div>
                    <div className="p-4 sm:p-6 md:p-7 lg:p-8 lg:border-r border-white/70">
                        <div className="num text-white/90! mb-2 sm:mb-3 md:mb-4 text-[11px] sm:text-xs md:text-sm lg:text-base">Heritage restorations</div>
                        <div className="font-display text-[36px] sm:text-[44px] md:text-[52px] lg:text-[56px] leading-none tracking-tightish text-white!">
                            04<em className="serif-em text-accent text-[18px] sm:text-[20px] md:text-[24px] lg:text-[20px]">.</em>
                        </div>
