            ...
            <div className="max-w-content mx-auto px-4 xs:px-6 lg:px-10">
                <div className="grid grid-cols-12 gap-8 lg:gap-16 xl:gap-24 items-start">
                    <div className="col-span-12 lg:col-span-7 order-2 lg:order-1">
                        ...
                        <div className="mt-8 xs:mt-10 space-y-4 xs:space-y-6 text-[14px] xs:text-[15px] leading-relaxed sm:leading-[1.75] text-mute max-w-full sm:max-w-[620px] font-light">
                            <p>
                    ...
                    <aside className="col-span-12 lg:col-span-5 order-1 lg:order-2 lg:sticky lg:top-32 mt-4 lg:mt-0">
                        <figure className="rounded-[18px] xs:rounded-[24px] overflow-hidden aspect-[4/3] xs:aspect-[1/1] lg:aspect-[4/5] shadow-2xl transition-transform duration-700 hover:scale-[1.02]">
                            <Photo
